...
function PAGE_HTML(subtitle, toPills, fromPills, cityOptions, dateBlocksHtml, totalCount, groupCount, tier, userEmail, userPhone, tzPref, userDisplayName) {
    ...
    return '<!DOCTYPE html>\n<html lang="en">\n<head>\n' +
        ...
        '<div id="pm-verify-cta" style="display:none;margin-bottom:10px;padding:12px 14px;background:#fffbeb;border:1px solid #fde68a;border-radius:10px;font-size:13px;color:#92400e;">&#128274; <strong>WhatsApp verification required</strong> to post a ride. <a href="/verify/wa?returnTo=/" style="color:#500000;font-weight:700;">Verify now &rarr;</a></div>' +
