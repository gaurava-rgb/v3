...
app.get('/', optionalAuth, async function(req, res) {
    try {
        ...
        var html = [
            ...
            '  .auth-banner { background: #fef3c7; border: 1px solid #f59e0b; border-radius: 6px; padding: 8px 16px; margin-bottom: 10px; font-size: 13px; color: #92400e; display: flex; align-items: center; justify-content: space-between; gap: 12px; }',
            '  .auth-banner a { color: #500000; font-weight: 700; text-decoration: underline; }',
            '  .auth-banner-close { cursor: pointer; color: #92400e; font-size: 18px; line-height: 1; opacity: 0.6; background: none; border: none; }',
