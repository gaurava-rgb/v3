...
function renderListingPage(listing, isLoggedIn, isWaVerified) {
    ...
    if (isWaVerified) {
        ...
        contactHtml = [
            ...
            '  <div class="signin-prompt-text">Verify your WhatsApp to see contact info</div>',
            '  <a class="signin-btn" href="/login/phone">Verify via WhatsApp</a>',
            '</div>'
        ].join('\n');
    } else {
        ...
        contactHtml = [
            ...
            '  <a class="signin-btn" href="/login">Sign in with TAMU email</a>',
            '</div>'
        ].join('\n');
    }
