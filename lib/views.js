...
function renderListingPage(listing, isLoggedIn) {
    ...
    if (isLoggedIn) {
        ...
        if (listing.contact_phone) {
            var cp = String(listing.contact_phone).replace(/\D/g, '');
        ...
        contactHtml = [
            ...
            listing.contact_phone ? '  <div class="contact-row"><strong>Phone:</strong> ' + h.escHtml(phoneDisplay) + '</div>' : '',
            listing.contact_info ? '  <div class="contact-row">' + h.escHtml(listing.contact_info) + '</div>' : '',
            (!listing.contact_phone && !listing.contact_info) ? '  <div class="contact-row muted">No contact info provided.</div>' : '',
            '</div>'
