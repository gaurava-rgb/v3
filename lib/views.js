...
function renderHousingBoard(listings, activeFilter, tier) {
    ...
    function buildCard(l) {
        ...
        return [
            '<article class="listing ' + cls + '"' + city + dataPriceAttr + dataBedsAttr + ' tabindex="0" role="button" aria-expanded="false">',
