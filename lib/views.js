...
function renderProfilePage(user, profile) {
    ...
    var name    = (profile && (profile.display_name || profile.wa_name)) || 'No name set';
    ...
    return [
        ...
        '.edit-hint { font-size:12px; color:#aeaeb2; margin-top:12px; }',
        ...
        '    <div class="field-value muted">Not linked yet — coming soon</div>',
        '  </div>',

        '  <p class="edit-hint">Editing coming in a future update.</p>',
        '</div>',
